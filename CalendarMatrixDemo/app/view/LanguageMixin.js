// Following is copied from Sencha Touch Calendar Picker language example (https://github.com/swluken/TouchTreeGrid).
// Only required changes were made to this version to get this to work in EXTJS 
// Refer to EXTJS Locale implemenation/examples for more accurate and recommended implementation.

Ext.define('CalendarMatrix.view.LanguageMixin', {
    languageCalendarOverrides: function(me, code, language) {
        ...
        */
        ...
        Ext.Date.getShortDayName = function(day) {   // Initialize default function unless overridden below
        ...
        var languageSelect = this.lookupReference('languageSelect');  // this.getLanguageSelect();  // EXTJS modification
